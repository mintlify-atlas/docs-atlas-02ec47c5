...
<CardGroup cols={3}>
  <Card title="Authenticate" icon="key" href="/api-reference/authentication/sign-in">
    Sign in with your Telegram phone number and receive a one-time code — no bot token needed.
  </Card>
  <Card title="Manage Channels" icon="satellite-dish" href="/api-reference/channels/list-channels">
    List all your Telegram channels, join new ones by username, or leave channels programmatically.
  </Card>
  <Card title="Fetch Messages" icon="message" href="/api-reference/messages/get-messages">
